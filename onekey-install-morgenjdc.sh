...
git clone https://ghproxy.com/https://github.com/Eternity-luo/jd_zs.git /root/nolanjdc
...
-it --privileged=true  morgenl/nvjdc:ark
...
update_nvjdc(){
  ...
  cd /root/nolanjdc && git pull https://ghproxy.com/https://github.com/Eternity-luo/jd_zs.git
fi
